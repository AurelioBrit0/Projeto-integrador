 ...
 * @author jaimedias
 */
public class ContasPagarTela extends javax.swing.JDialog {
     ...
     */
    public ContasPagarTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        montaTabela();
        validaTela("inicio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContasPagarTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContasPagarTela dialog = new ContasPagarTela(new javax.swing.JFrame(), true);
