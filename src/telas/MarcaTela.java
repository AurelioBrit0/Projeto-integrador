 ...
 * @author jaimedias
 */
public class MarcaTela extends javax.swing.JDialog {
    ...
    /**
     * Creates new form MarcaTela
     */
    public MarcaTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        montaTabela();
        validaTela("inicio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcaTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MarcaTela dialog = new MarcaTela(new javax.swing.JFrame(), true);
